export default function Footer() {
    return (
        <a className=" absolute top-280 left-320 flex gap-2 w-fit p-2 place-self-end
        bg-black rounded-md cursor-pointer
        hover:scale-102 transition-transform" href="https://www.github.com/santimgb98">
            ...
            <p className="text-sm">santimgb98</p>
