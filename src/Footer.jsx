export default function Footer() {
    return (
        <>
            <div className="flex gap-5 absolute top-280 left-290 ">
                <p className="font-bold text-black">Creador: </p>
                <a className="flex gap-2 w-fit p-2 place-self-end
        bg-black rounded-md cursor-pointer
        hover:scale-102 transition-transform" href="https://www.github.com/santi-clase-DAM">
                    ...
                    <p className="text-sm">Santi Martínez</p>
                </a>
            </div>
